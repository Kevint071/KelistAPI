...
{
    public class UserDTO(Guid id, string personName, string lastName, string email, string passwordHash, DateTime createdAt, DateTime updatedAt, string role = "User", string? refreshToken = null, DateTime? refreshTokenExpiryTime = null, List<TaskListDTO>? taskLists = null)
    {
        ...
        private UserDTO() : this(Guid.Empty, string.Empty, string.Empty, string.Empty, string.Empty, DateTime.MinValue, DateTime.MinValue, "User") { }
